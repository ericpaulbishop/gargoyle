...
email.TLSinstallText="TLS encryption support is currently not installed (&gt;4MB space needed).";
email.installTLS="Install TLS support";
...
email.SumGo="E-mail will be sent on";
email.SumAt="at";
email.actv="active";
...
email.TLSfailed="ARP table";
email.SMTPfailed="Bandwidth usage";
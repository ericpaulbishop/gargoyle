...
DyDNS.AddDy="Añadir Servicio de DNS Dinámico";
DyDNS.SvPro="Proveedor de Servicio";
DyDNS.ChItv="Intervalo de Comprobación";
DyDNS.FUItv="Forzar Intervalo de Actualización";
DyDNS.AddDDNS="Añadir Servicio DDNS";
...
DyDNS.HelpFI="<em>Forzar Intervalo de Actualización</em> especifica la frecuencia con la que el enrutador se conectará a su proveedor de servicio DNS dinámico y actualizará sus registros, incluso si su IP no ha cambiado. Los proveedores de servicios prohiben a los usuarios que actualizan con demasiada frecuencia, pero pueden llegar a cerrar las cuentas de usuarios que no se actualicen por un mes entero. Se recomienda que se establezca este parámetro entre 3 y 7 días.";
DyDNS.UpErr1="La actualización de la(s) nueva(s) configuración(es) del servicio de DNS dinámico ha fallado";
DyDNS.UpErr2="Los Servicios no han podido ser actualizados correctamente por lo que se han sido eliminados.";
...
DyDNS.ModErr="Este servicio ha sido añadido/modificado y por lo tanto debe guardar sus cambios antes de que una actualización pueda ser realizada. Haga clic en\""+UI.SaveChanges+"\" e intente nuevamente.";
DyDNS.UpFErr="Ha fallado la actualización. Asegúrese de que su configuración es válida y de que se encuentra conectado a Internet.";

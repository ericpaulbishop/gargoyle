...
qosStr.MaxBandAbout="<em>Maximale Bandbreite</em> gibt den absoluten maximalen Wert der Bandbreite in kbit/s an die diese Klasse nutzen kann. Auch wenn noch ungenutze Bandbreite verfügbar ist, wird dieser Service-Klasse nicht gestattet mehr als diese Bandbreite zu nutzen.";
...
qosStr.DefServClassAbout="Die <em>Standard Service-Klasse</em> gibt an wie Packete auf die keine Regel zutrifft eingestufft werden sollen.";
...
qosStr.ServClass="Standard Service-Klasse";

qosStr.AddNewClassRule="Neue Classification Regel einfügen";
qosStr.AddNewServiceRule="Neue Service Class einfügen";

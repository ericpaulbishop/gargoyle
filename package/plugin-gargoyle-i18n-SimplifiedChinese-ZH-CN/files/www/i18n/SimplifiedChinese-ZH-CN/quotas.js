...
quotasStr.Section="带宽配额";
quotasStr.AddQuota="添加新配额";
quotasStr.ActivQuotas="活动的配额";
quotasStr.IPs="IP(s)";
quotasStr.Active="活动";
quotasStr.Limits="限制";
...
//quota_usage.sh/js
quotasStr.USect="带宽配额使用情况";
quotasStr.All="所有";
quotasStr.Alws="总是";
quotasStr.ColNms=["主机","活动","%总量已使用","%下载量已使用","%上传量已使用"];

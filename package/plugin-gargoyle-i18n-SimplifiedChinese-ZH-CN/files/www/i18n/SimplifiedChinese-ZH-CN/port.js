...
prtS.NoMiniupnpdErr="需要安装额外软件包启用此选项!";
prtS.POISect="单个端口转发";
prtS.OpeIPort="从WAN端到LAN端转发单个端口";
prtS.PORSect="端口范围转发";
prtS.OpeRPort="从WAN端到LAN端转发端口范围";
...
prtS.LHst="LAN主机";
prtS.Port="端口";
prtS.AORErr="无法添加端口转发规则.";
prtS.DupOErr="范围内的端口已被转发到该IP";
prtS.CopOErr="端口已被转发到该IP";
prtS.UpOErr="无法更新端口转发。";

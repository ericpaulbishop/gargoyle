			...
			<div class="panel-body">
				...
				<div class="col-lg-6">
					...
					<div id="wan_static_ip6_container" class="row form-group">
						...
						<span class="col-xs-7"><input type="text" class="form-control" name="wan_static_ip6" id="wan_static_ip6" onkeyup="proofreadIp6ForceRange(this)" /></span>
					</div>
					...
					<div id="wan_static_gateway6_container" class="row form-group">
						...
						<span class="col-xs-7"><input type="text" class="form-control" name="wan_static_gateway6" id="wan_static_gateway6" onkeyup="proofreadIp6(this)" /></span>
					</div>
				</div>
			...
			<div class="panel-body">
				...
				<div class="col-lg-6">
					...
					<div id="lan_ip6addr_container" class="row form-group">
						...
						<input  type="text" id="add_lan_ip6" class="form-control" onkeyup="proofreadIp6ForceRange(this)" />
					...
					<div id="lan_ip6assign_parent_container" class="row form-group">
						...
						<span class="col-xs-7 col-xs-offset-5" id="lan_ip6assign_container"><input type="text" class="form-control" name="lan_ip6assign" id="lan_ip6assign" onkeyup="proofreadNumericRange(this,1,128)" /></span>
					</div>

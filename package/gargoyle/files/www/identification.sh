		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="row form-group">
					...
					<span class="col-xs-7"><input type="text" id="hostname" class="form-control" oninput="proofreadText(this,validateHostName,0)"  size="35" maxlength="25"/></span>
				</div>
				
				<div id="domain_container" class="row form-group">
					<label class="col-xs-5" for="domain" id="domain_label"><%~ Domn %></label>
					<span class="col-xs-7"><input type="text" id="domain" class="form-control" oninput="proofreadText(this,validateDomain,0)" size="35" maxlength="100"/></span>
				</div>
			</div>
		</div>
	</div>

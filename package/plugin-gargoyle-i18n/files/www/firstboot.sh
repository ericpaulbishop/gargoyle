...
<%
	...
	gargoyle_header_footer -h -c "internal.css" -j "i18n.js firstboot.js table.js plugins.js" -z "firstboot.js" system 
%>
...
<fieldset>
	...
	<div>
		...
		<br/>
		<div align="left">
			<img src="i18n/graphics/timezones.gif" style="padding:30px 0 0 30px;" />
		</div>
	</div>
	<br/>
	<div>
